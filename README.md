...
-Real-time Validation: Client and server-side validation mechanisms 
-Admin Dashboard: Comprehensive data management interface  

Technologies Used
-Backend: PHP, MySQL 
-Frontend: HTML5, CSS3, JavaScript 
-Security: Bcrypt, RBAC, Input Sanitization  
-Tools: XAMPP, GitHub 
...
-Data Protection - Bcrypt password hashing 
  Prepared statements to prevent SQL injection - Input validation and sanitization  
...
-Designed to handle national-scale data securely 
